...
export const $$__REACT_INTERNALS__: ReactInternals = {
  ...
  describeFiber: function describeFiber(workInProgress, currentDispatcherRef) {
    const {
      FunctionComponent,
  ...
  describeNativeComponentFrame: function describeNativeComponentFrame(
    ...
    // @ts-expect-error It does accept undefined.
        ...
        DetermineComponentFrameRoot() {
          ...
          try {
            ...
            if (
              ...
              return [(sample as Error).stack, (control as Error).stack];
            }
          }
          return [null, null];
        },
